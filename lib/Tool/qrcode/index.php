 ...
 *
 */
$table_spec = 'asset_item as ai inner join asset as a ON ai.assetid = a.id inner join asset_type as at on at.id = a.typeid';
 ...
 */
 $datagrid->setSQLColumn('ai.itemcode',
 'ai.itemcode AS \''.__('Item Code').'\'',
 'a.name AS \''.__('Name').'\'',
 'at.name AS \'Tipe Barang\'');

$datagrid->setSQLorder('ai.lastupdate DESC');
...
if (isset($_GET['keywords']) AND $_GET['keywords']) {
    ...
    $searchable_fields = array('a.name', 'ai.itemcode');
    $search_str = '';
    ...
    $criteria = '(' . substr_replace($search_str, '', -4) . ')';
}
...
$datagrid->column_width = array('10%', '45%', '65%');
