 ...
 * @modify date 2021-08-14 14:39:38
 * @desc [description]
 */
...
class exportItem
{
    ...
    public static function render()
    {
        ...
        // set property
        $property = [
            'submit_button_attr' => 'name="exportData" value="' . __('Export') . '" class="s-btn btn btn-default"',
