...
class addAsset
{
    ...
    private static function setItems()
    {
        ...
        $formElement = [
            'codeList' => FE::selectList('itemCodePattern', [], '', 'class="form-control col"'),
        ...
        $translate = [
            ...
            'shelLocationTrans' => __('Shelf Location'),
            'collectionTypeTrans' => __('Collection Type'),
            'ItemStatusTrans' => __('Item Status'),
        ...
        $item = <<<HTML
            <div class="form-inline">
                ...
                {$itemSite}
                <div class="form-group divRow p-1"><div class="col-3">{$collectionTypeTrans}</div>
                {$collType}
